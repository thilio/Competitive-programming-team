/*
   ...
   Description: Mo's algorithm to solve number of distinct elements in range
   Complexity: O(n + q sqrt(n))
   Details: Mo's algorithm can be used when queries are offline and
   			it is easy to insert and erase one element in the answer
