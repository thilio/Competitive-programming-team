/*
   ...
   Description: Segment tree which one has total control of time
   ...
   Details: Total persistance, one may visit, change and create new
   	versions on time.
*/


#define oper(a, b) a + b // operation
